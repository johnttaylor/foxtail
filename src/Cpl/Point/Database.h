#ifndef Cpl_Point_Database_h_
#define Cpl_Point_Database_h_
/*-----------------------------------------------------------------------------
...
public:
    ...
    Cpl::Point::Api* lookupById( const Identifier_T pointIdToFind, bool fatalOnNotFound=false ) const noexcept;
