...
public:
    ...
    virtual void write( Int32& src, Cpl::Point::Api::LockRequest_T lockRequest = Cpl::Point::Api::eNO_REQUEST ) noexcept 
    {
        if ( src.isNotValid() )
        {
            setInvalid();
        ...
        {
            BasicInteger_<int32_t>::write( src.m_data, lockRequest );
        }
    }
...
public:
    ...
    ///  See Cpl::Point::Api
    size_t getTotalSize() const noexcept { return sizeof( Int32 ); }

public:
    /// Creates a concrete instance in the invalid state
    static Api* create( Cpl::Memory::Allocator& allocatorForPoints, uint32_t pointId ) { return new(allocatorForPoints.allocate( sizeof( Int32 ) )) Int32( pointId ); }
