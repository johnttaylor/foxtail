...
public:
    ...
    ///  See Cpl::Point::Api
    size_t getTotalSize() const noexcept { return sizeof( Int16 ); }

public:
    /// Creates a concrete instance in the invalid state
    static Api* create( Cpl::Memory::Allocator& allocatorForPoints, uint32_t pointId ) { return PointCommon_::create<Int16>( allocatorForPoints, pointId ); }
