...
constexpr Uint64::Id_T  appleId  = 0;
constexpr Uint64::Id_T  orangeId = 1;

#define ORANGE_INIT_VAL 7

static Uint64 apple_( appleId );
static Uint64 orange_( orangeId, ORANGE_INIT_VAL );
...
TEST_CASE( "Uint64" )
{
    ...
    SECTION( "create" )
    {
        Cpl::Memory::HPool<Uint64> heap( 1 );
        Api* pt = Uint64::create( heap, 0 );
        REQUIRE( pt );
    ...
    SECTION( "read" )
    {
        ...
        REQUIRE( apple_.getSize() == sizeof( uint64_t ) );
    }
