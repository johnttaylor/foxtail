...
constexpr Uint16::Id_T  appleId  = 0;
constexpr Uint16::Id_T  orangeId = 1;

#define ORANGE_INIT_VAL 7

static Uint16 apple_( appleId );
static Uint16 orange_( orangeId, ORANGE_INIT_VAL );
...
TEST_CASE( "Uint16" )
{
    ...
    SECTION( "create" )
    {
        Cpl::Memory::HPool<Uint16> heap( 1 );
        Api* pt = Uint16::create( heap, 0 );
        REQUIRE( pt );
    ...
    SECTION( "read" )
    {
        ...
        REQUIRE( apple_.getSize() == sizeof( uint16_t ) );
    }
