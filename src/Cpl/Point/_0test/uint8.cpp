...
constexpr Uint8::Id_T  appleId  = 0;
constexpr Uint8::Id_T  orangeId = 1;

#define ORANGE_INIT_VAL 7

static Uint8 apple_( appleId );
static Uint8 orange_( orangeId, ORANGE_INIT_VAL );
...
TEST_CASE( "Uint8" )
{
    ...
    SECTION( "create" )
    {
        Cpl::Memory::HPool<Uint8> heap( 1 );
        Api* pt = Uint8::create( heap, 0 );
        REQUIRE( pt );
    ...
    SECTION( "read" )
    {
        ...
        REQUIRE( apple_.getSize() == sizeof( uint8_t ) );
    }
