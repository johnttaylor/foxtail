...
///////////////////////////////////////////////////////////////////////////////
bool DemuxBase::parseConfiguration( Cpl::Memory::ContiguousAllocator& generalAllocator, JsonVariant& obj, unsigned maxOutputs ) noexcept
{
    ...
    if ( !outputs.isNull() )
    {
        ...
        if ( nOutputs == 0 || nOutputs > maxOutputs )
        {
