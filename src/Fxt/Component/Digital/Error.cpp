...
void Fxt::Component::Digital::errorCodetoText_( Cpl::Text::String& buffer, Fxt::Type::Error errorCode, uint8_t levelIndex ) noexcept
{
    // Card level
    ...
    else
    {
        ...
        //{
        //case Err_T::DIGITAL:
        //    XXXX::errorCodetoText_( buffer, errorCode, levelIndex + 1 );
        //    break;
