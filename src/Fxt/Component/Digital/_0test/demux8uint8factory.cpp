...
#include "Fxt/Component/Digital/Demux8Uint8.h"
...
TEST_CASE( "Demux8Uint8Factory" )
{
    ...
    Demux8Uint8Factory                              uut( componentFactoryDb );
    ...
    SECTION( "create/destroy card" )
    {
        ...
        REQUIRE( strcmp( component->getTypeName(), Demux8Uint8::TYPE_NAME ) == 0 );
        REQUIRE( strcmp( component->getTypeGuid(), Demux8Uint8::GUID_STRING ) == 0 );
