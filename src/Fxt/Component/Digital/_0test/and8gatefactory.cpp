...
#include "Fxt/Component/Digital/And8Gate.h"
...
TEST_CASE( "And8GateFactory" )
{
    ...
    And8GateFactory                    uut( componentFactoryDb );
    ...
    SECTION( "create/destroy card" )
    {
        ...
        REQUIRE( strcmp( component->getTypeName(), And8Gate::TYPE_NAME ) == 0 );
        REQUIRE( strcmp( component->getTypeGuid(), And8Gate::GUID_STRING ) == 0 );
