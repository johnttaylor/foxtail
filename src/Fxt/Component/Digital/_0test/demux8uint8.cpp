...
TEST_CASE( "Demux8Uint8" )
{
    ...
    SECTION( "create component" )
    {
        ...
        REQUIRE( strcmp( uut.getTypeGuid(), Demux8Uint8::GUID_STRING ) == 0 );
        REQUIRE( strcmp( uut.getTypeName(), Demux8Uint8::TYPE_NAME ) == 0 );
