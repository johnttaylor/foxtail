#ifndef Fxt_Node_SBC_PiPicoDemo_Drivers_h_
#define Fxt_Node_SBC_PiPicoDemo_Drivers_h_
/*-----------------------------------------------------------------------------
...
#ifndef OPTION_FXT_NODE_SBC_PIPICODEMO__CHASSIS_RHTEMP_SENSORS_NUM_SUPPORTED 
#define OPTION_FXT_NODE_SBC_PIPICODEMO__CHASSIS_RHTEMP_SENSORS_NUM_SUPPORTED    1 
#endif

/// Required Starting Slot number for the RH/Temperature Sensor (when used)
#ifndef OPTION_FXT_NODE_SBC_PIPICODEMO__CHASSIS_RHTEMP_SENSOR_BASE_SLOTNUM  
#define OPTION_FXT_NODE_SBC_PIPICODEMO__CHASSIS_RHTEMP_SENSOR_BASE_SLOTNUM      255
#endif
