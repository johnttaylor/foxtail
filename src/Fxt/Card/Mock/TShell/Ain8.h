...
*/
#define FXTCARDMOCKTSHELL_USAGE_AIN8_       "ain8 setcard <chassisIdx> <slot-num> \n" \
                                            "ain8 wi <channel-num> <val>\n" \
                                            "ain8 ri [<channl-num>]"

/// Detailed Help text
#ifndef FXTCARDMOCKTSHELL_DETAIL_AIN8_
#define FXTCARDMOCKTSHELL_DETAIL_AIN8_      "  Reads ('ri') and writes ('wi') the mock cards's inputs.  The user must first\n" \
                                            "  identify which card instance to operate on by using the 'setcard' subcommand"
