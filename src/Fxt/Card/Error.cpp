...
void Fxt::Card::errorCodetoText_( Cpl::Text::String& buffer, Fxt::Type::Error errorCode, uint8_t levelIndex ) noexcept
{
    // Card level
    ...
    else
    {
        ...
        {
        case Err_T::MOCK:
            Mock::errorCodetoText_( buffer, errorCode, levelIndex + 1 );
            break;
