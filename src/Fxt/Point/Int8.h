...
public:
    ...
    Int8( DatabaseApi&                      db, 
        ...
        : BasicInteger_<int8_t>(db, pointId, allocatorForPointStatefulData, setterPoint ) {}
...
public:
    ...
    ///  See Fxt::Point::Api
    void updateFromSetter() noexcept { if ( m_setter ) { write( *((Int8*) m_setter) ); } }
    ...
    {
        if ( !beSafe || isSameType( srcPt ) ) { write( *((Int8*) &srcPt), lockRequest ); }
    }
