...
constexpr Int64::Id_T  appleId  = 0;
constexpr Int64::Id_T  orangeId = 1;

#define ORANGE_INIT_VAL 7

static Int64 apple_( appleId );
static Int64 orange_( orangeId, ORANGE_INIT_VAL );
...
TEST_CASE( "Int64" )
{
    ...
    SECTION( "read" )
    {
        ...
        REQUIRE( apple_.getSize() == sizeof( int64_t ) );
    }
