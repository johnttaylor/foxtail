...
static size_t stateHeapMemory_[ELEM_SIZE_AS_SIZET( sizeof( Int8::StateBlock_T ) ) * MAX_POINTS];
...
TEST_CASE( "Int8" )
{
    ...
    Int8* apple = new(std::nothrow) Int8( db, APPLE_ID, stateHeap );
    REQUIRE( apple );
    Int8* orange = new(std::nothrow) Int8( db, ORANGE_ID, stateHeap );
    REQUIRE( orange );
